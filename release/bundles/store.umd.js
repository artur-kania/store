(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/BehaviorSubject'), require('@angular/core'), require('@ngrx/core'), require('rxjs/Observer'), require('rxjs/Observable'), require('rxjs/Subscriber'), require('rxjs/Operator'), require('rxjs/operator/withLatestFrom'), require('rxjs/operator/scan'), require('rxjs/operator/observeOn'), require('rxjs/scheduler/queue')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs/BehaviorSubject', '@angular/core', '@ngrx/core', 'rxjs/Observer', 'rxjs/Observable', 'rxjs/Subscriber', 'rxjs/Operator', 'rxjs/operator/withLatestFrom', 'rxjs/operator/scan', 'rxjs/operator/observeOn', 'rxjs/scheduler/queue'], factory) :
    (factory((global.ngrx = global.ngrx || {}, global.ngrx.store = global.ngrx.store || {}),global.Rx,global.ng.core,global.ngrx.core,global.rxjs_Observer,global.Rx,global.Rx,global.rxjs_Operator,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Scheduler));
}(this, (function (exports,rxjs_BehaviorSubject,_angular_core,_ngrx_core,rxjs_Observer,rxjs_Observable,rxjs_Subscriber,rxjs_Operator,rxjs_operator_withLatestFrom,rxjs_operator_scan,rxjs_operator_observeOn,rxjs_scheduler_queue) { 'use strict';
...
var INITIAL_REDUCER = new _angular_core.InjectionToken('Token ngrx/store/reducer');
var INITIAL_STATE = new _angular_core.InjectionToken('Token ngrx/store/initial-state');
var _INITIAL_REDUCER = new _angular_core.InjectionToken('Token _ngrx/store/reducer');
var _INITIAL_STATE = new _angular_core.InjectionToken('Token _ngrx/store/initial-state');
